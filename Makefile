#############################################################################
# Makefile for building: MonitorRig
# Generated by qmake (3.1) (Qt 5.9.1)
# Project:  MonitorRig.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile MonitorRig.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_SERIALPORT_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtSerialPort -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MonitorRig1.0.0
DISTDIR = /mnt/sda2/git/MonitorRig/.tmp/MonitorRig1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lQt5Gui -lQt5Network -lQt5SerialPort -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp \
		openmonitorrig.cpp \
		openserial.cpp moc_openmonitorrig.cpp \
		moc_openserial.cpp
OBJECTS       = main.o \
		openmonitorrig.o \
		openserial.o \
		moc_openmonitorrig.o \
		moc_openserial.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		MonitorRig.pro openmonitorrig.h \
		openserial.h main.cpp \
		openmonitorrig.cpp \
		openserial.cpp
QMAKE_TARGET  = MonitorRig
DESTDIR       = 
TARGET        = MonitorRig
...
Makefile: MonitorRig.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile MonitorRig.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents openmonitorrig.h openserial.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp openmonitorrig.cpp openserial.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_openmonitorrig.cpp moc_openserial.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_openmonitorrig.cpp moc_openserial.cpp
moc_openmonitorrig.cpp: openmonitorrig.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/mnt/sda2/git/MonitorRig -I/usr/include/qt -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtSerialPort -I/usr/include/qt/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include-fixed -I/usr/include openmonitorrig.h -o moc_openmonitorrig.cpp

moc_openserial.cpp: openserial.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/mnt/sda2/git/MonitorRig -I/usr/include/qt -I/usr/include/qt/QtGui -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtSerialPort -I/usr/include/qt/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include-fixed -I/usr/include openserial.h -o moc_openserial.cpp
...
main.o: main.cpp openmonitorrig.h \
		openserial.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

openmonitorrig.o: openmonitorrig.cpp openmonitorrig.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o openmonitorrig.o openmonitorrig.cpp

openserial.o: openserial.cpp openserial.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o openserial.o openserial.cpp

moc_openmonitorrig.o: moc_openmonitorrig.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_openmonitorrig.o moc_openmonitorrig.cpp

moc_openserial.o: moc_openserial.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_openserial.o moc_openserial.cpp
